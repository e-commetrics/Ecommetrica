...
export default function FaqPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-20 lg:px-10 lg:py-28">
      <h1 className="font-display text-4xl font-medium tracking-tight text-ecom-dark">
        FAQ
      </h1>
      <div className="mt-12 flex flex-col divide-y divide-ecom-dark/10">
        {faqs.map((faq) => (
          <div key={faq.question} className="py-6 first:pt-0">
            <h2 className="font-display text-lg font-medium text-ecom-dark">
              {faq.question}
            </h2>
            <p className="mt-2 text-ecom-dark/70">{faq.answer}</p>
          </div>
        ))}
      </div>
    </div>
