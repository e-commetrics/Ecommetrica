...
export const dict: Record<Lang, Dict> = {
  es: {
    ...
    hero: {
      ...
      headlinePre: "Creamos",
      headlineAccent: "marcas",
      headlinePost: "que transforman industrias e impulsan negocios.",
  ...
  en: {
    ...
    hero: {
      ...
      headlineAccent: "brands",
      headlinePost: "that transform industries and boost businesses.",
